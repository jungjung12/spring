 ...
 * Generated at: 2024-06-24 07:59:11 UTC
...
public final class insertForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                                <img id=\"kakao\" src=\"https://t1.kakaocdn.net/friends/www/talk/kakaofriends_talk_2018.png\" alt=\"가여운 제이지..\">\r\n");
      out.write("                            </div>\r\n");
      out.write("                        </th>\r\n");
      out.write("                    </tr>\r\n");
      out.write("                </table>\r\n");
      ...
      out.write("                    \r\n");
      out.write("                    //inputFile.files.length : 1 == 파일 첨부 , 0 == 첨부 취소 \r\n");
      out.write("                    // 파일 첨부 시 inputFile.files[0]에 선택된 파일의 정보가 있음\r\n");
      out.write("                    \r\n");
      out.write("                    if(inputFile.files.length) { //파일이 첨부\r\n");
      out.write("                    \r\n");
      out.write("                       //선택된 파일을 읽어서 영역에 미리보기 해야 함\r\n");
      out.write("                       //파일을 읽어들일 FileReader 객체 생성\r\n");
      out.write("                       const reader = new FileReader();\r\n");
      out.write("                    \r\n");
      out.write("                       //reader 객체를 통해 파일을 읽어들이는 메서드 호출\r\n");
      out.write("                       reader.readAsDataURL(inputFile.files[0]);\r\n");
      out.write("                       \r\n");
      out.write("                       // 해당 파일을 read 하는 순간 파일만의 고유한 거어어어어어ㅓ엉ㅂ나 긴 url이 생성됨\r\n");
      out.write("                       // 해당 url을 src 속성의 값으로 부여\r\n");
      out.write("                       \r\n");
      out.write("                       //파일 읽기가 완료되면 실행할 핸들러 정의\r\n");
      out.write("                       //이벤트 종류 : event type\r\n");
      out.write("                       //이벤트 발생 타겟 : event target\r\n");
      out.write("                       //이벤트 발생으로 처리되는 코드 : event handler\r\n");
      out.write("                       reader.onload = e => {\r\n");
      out.write("                          document.getElementById('preImage').src = e.target.result;\r\n");
      out.write("                       };\r\n");
      out.write("                       \r\n");
      out.write("                    } else {\r\n");
      out.write("                       document.getElementById('preImage').src = \"https://t1.kakaocdn.net/friends/www/talk/kakaofriends_talk_2018.png\";\r\n");
      out.write("                    \r\n");
      out.write("                    \r\n");
      out.write("                 }\r\n");
      out.write("				/* function loadImg(inputFile) {\r\n");
      ...
      out.write("					\r\n");
      out.write("					/* console.log(inputFile.files);\r\n");
      out.write("					files : 업로드된 파일의 정보가 들어있음\r\n");
      out.write("					inputFile.files.length : 1 == 파일 첨부 / 0 == 첨부 취소 -> 파일의 존재 유무를 알 수 있음 */\r\n");
      out.write("					\r\n");
      out.write("					if(inputFile.files.length) { //파일이 첨부되었으면\r\n");
      out.write("						\r\n");
      out.write("						//선택된 파일을 읽어서 영역에 미리 보기\r\n");
      out.write("						//파일을 읽어들일 FileReader 객체 생성\r\n");
      out.write("						\r\n");
      out.write("						const reader = new FileReader();\r\n");
      out.write("					\r\n");
      out.write("						reader.readAsDataURL(inputFile.files[0]);\r\n");
      out.write("						\r\n");
      out.write("						//해당 파일을 read 하면 파일만의 고유한 아주 긴 url이 생성\r\n");
      out.write("						//위 url을 src 속성의 값으로 부여\r\n");
      out.write("						\r\n");
      out.write("						//파일 일기가 완료되면 실행할 핸들러 정의\r\n");
      out.write("						reader.onload = e => {\r\n");
      out.write("\r\n");
      out.write("							//e.target -> eventTarget\r\n");
